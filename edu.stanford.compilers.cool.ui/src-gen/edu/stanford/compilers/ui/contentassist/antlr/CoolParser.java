		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIntegerCompositeAccess().getGroup(), "rule__IntegerComposite__Group__0");
					...
					put(grammarAccess.getIntegerCompositeAccess().getExprAssignment_1(), "rule__IntegerComposite__ExprAssignment_1");
					...
					put(grammarAccess.getConditionalExpressionAccess().getElse_expAssignment_5(), "rule__ConditionalExpression__Else_expAssignment_5");
					...
					put(grammarAccess.getLetExpressionAccess().getBodyAssignment_3(), "rule__LetExpression__BodyAssignment_3");
