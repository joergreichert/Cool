 ...
 * <ul>
 *   <li>{@link edu.stanford.compilers.cool.impl.IdentifiableElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentifiableElementImpl extends MinimalEObjectImpl.Container implements IdentifiableElement
{
  ...
  {
    return CoolPackage.Literals.IDENTIFIABLE_ELEMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CoolPackage.IDENTIFIABLE_ELEMENT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CoolPackage.IDENTIFIABLE_ELEMENT__NAME:
        return getName();
    }
