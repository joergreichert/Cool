 ...
 * <ul>
 *   <li>{@link edu.stanford.compilers.cool.impl.AttrImpl#getType_decl <em>Type decl</em>}</li>
 *   <li>{@link edu.stanford.compilers.cool.impl.AttrImpl#getInit <em>Init</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AttrImpl extends Feature_Impl implements Attr
{
  /**
  ...
  {
    return CoolPackage.Literals.ATTR;
  }
    ...
    if (type_decl != null && type_decl.eIsProxy())
    {
      ...
      if (type_decl != oldType_decl)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CoolPackage.ATTR__TYPE_DECL, oldType_decl, type_decl));
      }
    }
    return type_decl;
  }
  ...
  public void setType_decl(Type newType_decl)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CoolPackage.ATTR__TYPE_DECL, oldType_decl, type_decl));
  }
  ...
  public NotificationChain basicSetInit(Expression newInit, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CoolPackage.ATTR__INIT, oldInit, newInit);
  ...
  public void setInit(Expression newInit)
  {
    if (newInit != init)
    {
      ...
      if (init != null)
        msgs = ((InternalEObject)init).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CoolPackage.ATTR__INIT, null, msgs);
      if (newInit != null)
        msgs = ((InternalEObject)newInit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CoolPackage.ATTR__INIT, null, msgs);
      msgs = basicSetInit(newInit, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CoolPackage.ATTR__INIT, newInit, newInit));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CoolPackage.ATTR__TYPE_DECL:
